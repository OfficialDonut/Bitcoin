...
class Messages {
    ...
    private void loadDefaults() {
        ...
        if (messagesConfig.getStringList("begin_exchange").get(2).equalsIgnoreCase("&aEnter the amount of bitcoins you would like to exchange:")) { messagesConfig.set("begin_exchange", Arrays.asList(" ", "&aYour balance: &2{BALANCE} bitcoins", "&aCurrent bitcoin value: &2{VALUE}", "&aEnter the amount of bitcoins you would like to sell:")); }
